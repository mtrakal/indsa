...
namespace cz.mtrakal.ADT {
    ...
    public class PriorityQueue<TPriority, TValue, TKey> where TPriority : IComparable<TPriority> {
        ...
        /// <remarks>
        /// Zapis throws <see cref="InvalidOperationException"/> if priority queue is empty
        /// </remarks>
        ...
        /// <summary>
        /// Copies the elements of the priority queue to an Array, starting at a particular Array blok. 
        /// </summary>
        ...
        /// <param name="arrayIndex">The zero-based blok in array at which copying begins.</param>
        /// <remarks>
